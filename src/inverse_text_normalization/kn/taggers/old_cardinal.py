...
class CardinalFst(GraphFst):
    ...
    def __init__(self):
        ...
        graph_hundred_component = pynini.union(graph_digit + delete_space + pynutil.delete(hundred_alt_2) + delete_space,
                                               pynutil.insert("0"))
        graph_hundred_component_alt = pynini.union(
            graph_digit + delete_space + pynutil.delete(hundred_alt) + delete_space,
            pynutil.insert("0"))
        graph_hundred_component_alt += pynini.union(graph_tens, pynutil.insert("0") + (graph_digit | pynutil.insert("0")))
